        ...
        <>
          <div className="flex flex-col items-center w-full gap-4 px-6 sm:px-16 md:px-24 lg:px-32 mb-10">
            ...
            <div className="bg-white rounded-[4px] p-4 flex items-center justify-between w-full max-w-[300px] shadow-lg">
              ...
              <div className="flex flex-col items-end opacity-80 w-[80px]">
              ...
              <div className="flex-grow">
                ...
                <ul className="list-none p-0 m-0 grid grid-cols-2 sm:grid-cols-4 gap-12 w-full">
                  <li className="flex gap-3 items-start">
                    <div className="relative w-10 h-10 flex-shrink-0" style={{ maxWidth: "40px", minWidth: "40px" }}>
                      ...
                      <span className="absolute bottom-0 right-0 w-4 h-4 rounded-full bg-[#1a847a] flex items-center justify-center translate-x-[2px] translate-y-[2px]">
                        <svg viewBox="0 0 24 24" className="w-2.5 h-2.5" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex items-start gap-3 flex-grow">
                ...
                <div>
                  ...
                  <div className="text-[12px] text-white/60">
                    <span className="font-bold text-[#1dbda0]">99.94%</span> of nearly 2225k+ rate as{" "}
                    <strong className="text-white">excellent!</strong>
                  </div>
                  <div className="text-[12px] text-white/60">
                    <strong className="text-white">You</strong> rated as{" "}
                    <strong className="text-white">excellent!</strong>
                  </div>
                </div>
              </div>
